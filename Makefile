...
HEADERS_TO_INSTALL       = $(addsuffix .hpp, LibPotentials Potentials Potentials Structure_Potentials Structure_Laser Structure_Element Vectors Version FloatType Constants)
